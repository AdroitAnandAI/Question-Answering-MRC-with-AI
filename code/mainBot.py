...
def main(unused_argv):
    ...
    if FLAGS.mode == "train":
        ...
        with open(os.path.join(FLAGS.train_dir, "flags.json"), 'w') as fout:
            print(FLAGS.__flags)
            json.dump(FLAGS.__flags, fout, indent=4, sort_keys=True, cls=TfAwareEncoder)
            # fout.write(unicode(json.dump(FLAGS.__flags, fout, ensure_ascii=False)))
        ...
        print "Context Token Data as below:"
        print context_token_data

        print "Qn Token Data as below:"
        print qn_token_data
